...
namespace Mauidon.WinUI.Services
{
    ...
    public class WindowsPlatformService
    {
        ...
        {
            var windowHandle = global::Windows.Win32.PInvoke.GetActiveWindow();
            IDataTransferManagerInterop interop = global::Windows.ApplicationModel.DataTransfer.DataTransferManager.As<IDataTransferManagerInterop>();
